...
public class filtradoDatos {
    ...
    public static boolean filtradoButacas(Sala[] cine, String idSala, String entradaButaca) {
        ...
        if (Integer.parseInt(entradaButaca.substring(1, 2)) > cine[0].cantidaMaxColumnas()) {
        ...
        for (char element : abecedario.toCharArray()) {
            ...
            if (contadorFilaSeleccionada > cine[0].cantidaMaxFilas()) {
                ...
                System.out.println();
                return false;
            } else if (Character.toString(element).equals(filaButaca) && contadorFilaSeleccionada <= cine[0].cantidaMaxFilas()) {
                return true;
            }
        }
